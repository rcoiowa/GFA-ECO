...
# Fee Schedule & Financial Agreement
...
- NARR 3.0: 1.A.3.a — fees disclosed before any funds accepted
- NARR 3.0: 1.A.3.b — accounting for resident financial transactions
- NARR 3.0: 1.A.3.c — refund terms disclosed
- NARR 3.0: 1.A.2.h — no staff involvement in resident finances
- Iowa HHS checklist: Fee transparency before admission
