...
- NARR 3.0: 3.G.20 — connection to recovery supports when they are needed most
- NARR 3.0: 3.I.28 — community response that protects the recovery environment
- NARR 3.0: 2.F.18 — overdose response readiness
- Iowa HHS checklist: Written return-to-use/relapse policy with safe-exit practices
