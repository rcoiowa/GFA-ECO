...
**Acknowledgment note (non-negotiable):** acknowledgment of a **placeholder** edition **does not** prove acknowledgment of the **complete** policy. Re-acknowledgment wording, notice, timing, and evidentiary treatment are **held for counsel** (DOC-INTEGRITY-001). No resident re-acknowledgment is implemented or required here.
...
| File | sha256 |
|---|---|
| `0152_grace_house_document_integrity.prepared.sql` | `2dce28e7ad491b5ed82e48212568ce120ed205ddf1e786d2161dcd672cf66e0c` |
