...
--
-- The four docs are requires_signature=false (ack-only); ensure_my_document_
-- assignments assigns signature docs only, so publishing a new version does NOT
-- auto-assign or compel re-signature.
--
