...
| ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- | ----------------------------------------------------------------- | -------------------- |
| Platform (staging)       | Worker `gfa-eco-recovery-residence-os` (static assets; config in `apps/platform/wrangler.jsonc`; adopts the 2026-07-30 dashboard stub — see `consolidation-2026-07-31.md`) | `gfa-eco-recovery-residence-os.<account>.workers.dev` | `pnpm --filter @recoveryos/platform build` then `wrangler deploy` | `apps/platform/dist` |
