 ...
 * source-documents/grace-house/GraceHouse_Complete_Operational_System_v2.docx — regenerate with
 * scripts/import-grace-house-docs (do not hand-edit the body).
 */
export const completeOperationalSystem: ResidenceDocument = {
  key: 'complete_operational_system',
  name: 'Complete Operational System (Staff Manual)',
  category: 'policy',
  version: '2.0',
  summary:
  ...
  narrReferences: [
    '1.D.12 — written procedures and role definitions',
    'Domain 1 — administrative operations',
  ],
  iowaChecklist: ['Operations evidence for certification'],
  body: `GRACE HOUSE
