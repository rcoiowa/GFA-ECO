...
export const overdosePreventionPolicy: ResidenceDocument = {
  key: 'overdose_prevention_policy',
  name: 'Overdose Prevention & Naloxone Policy',
  category: 'policy',
  version: '2026.07',
  summary:
    'Naloxone on site, everyone trained, and a promise: call for help every time — no one gets in trouble for saving a life.',
  requiresSignature: false,
  narrReferences: [
    '2.F.18 — emergency readiness including naloxone',
    '2.F.17 — home safety equipment',
  ],
  iowaChecklist: [
    'Naloxone maintained on site with trained staff/residents',
    'Overdose response procedure in writing',
  ],
  body: `# Overdose Prevention & Naloxone Policy
