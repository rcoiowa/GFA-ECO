...
export const codeOfEthics: ResidenceDocument = {
  key: 'code_of_ethics',
  name: 'Staff & Leadership Code of Ethics',
  category: 'policy',
  version: '2026.07',
  summary:
    'The ethical commitments every staff member, house leader, and volunteer signs — aligned with the NARR Code of Ethics.',
  requiresSignature: false,
  narrReferences: [
    '1.A.2 — code of ethics attested by all staff and volunteers',
    '3.H.26 — prosocial modeling by leadership',
  ],
  iowaChecklist: ['Staff code of ethics on file', 'Background check policy'],
  body: `# Staff & Leadership Code of Ethics
