 ...
 * source-documents/grace-house/GraceHouse_Code_of_Conduct.docx — regenerate with
 * scripts/import-grace-house-docs (do not hand-edit the body).
 */
export const codeOfConduct: ResidenceDocument = {
  key: 'code_of_conduct',
  ...
  narrReferences: [
    '2.F.16.a — alcohol and illicit drug prohibition',
    '3.H.26.a — empathy and positive regard modeled',
    '1.C.7.c — resident rights posted',
    '1.B.6.c — social media privacy',
  ],
  iowaChecklist: ['Item 2 — family-like shared living centered on peer support'],
