 ...
 * source-documents/grace-house/GraceHouse_Incident_Report_System.docx — regenerate with
 * scripts/import-grace-house-docs (do not hand-edit the body).
 */
export const incidentReportSystem: ResidenceDocument = {
  key: 'incident_report_system',
  ...
  narrReferences: ['1.A.4.a — data collection with privacy protected'],
