 ...
 * source-documents/grace-house/GraceHouse_Grievance_Policy_and_Form.docx — regenerate with
 * scripts/import-grace-house-docs (do not hand-edit the body).
 */
export const grievancePolicyForm: ResidenceDocument = {
  key: 'grievance_policy_form',
  name: 'Grievance Procedure & Form',
  category: 'policy',
  version: '1.0',
  summary:
  ...
  narrReferences: ['1.C.7.b — grievance policy with right to escalate'],
  iowaChecklist: ['Grievance procedure available and posted'],
