...
export const residentRights: ResidenceDocument = {
  ...
  version: '2026.07',
  summary:
    'What you are entitled to in this home, and what living in community asks of each of us.',
  requiresSignature: true,
  narrReferences: [
    '1.B.5 — rights communicated before admission',
    '1.B.6 — dignity, privacy, and nondiscrimination (including MAT)',
    '1.C.7 — resident voice in how the home runs',
  ],
  iowaChecklist: [
    'Written resident rights provided and posted',
    'Nondiscrimination including MOUD',
  ],
  body: `# Resident Rights & Responsibilities
