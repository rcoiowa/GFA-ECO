 ...
 * source-documents/grace-house/GraceHouse_Emergency_Response_Protocols.docx — regenerate with
 * scripts/import-grace-house-docs (do not hand-edit the body).
 */
export const emergencyResponseProtocols: ResidenceDocument = {
  ...
  narrReferences: [
    '2.F.19.a — emergency numbers and evacuation maps posted',
    '2.F.19.c — residents oriented to emergency procedures',
    '2.F.19.d — naloxone accessible, individuals trained',
  ],
  iowaChecklist: ['Fire safety and emergency procedures', 'Naloxone on site with training'],
  body: `# GRACE FOR ADDICTIONS
