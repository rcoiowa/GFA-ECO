 ...
 * source-documents/grace-house/GraceHouse_Resident_Handbook.docx — regenerate with
 * scripts/import-grace-house-docs (do not hand-edit the body).
 */
export const residentHandbook: ResidenceDocument = {
