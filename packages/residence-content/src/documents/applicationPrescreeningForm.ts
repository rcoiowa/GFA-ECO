 ...
 * source-documents/grace-house/GraceHouse_Application_and_PreScreening_Form.docx — regenerate with
 * scripts/import-grace-house-docs (do not hand-edit the body).
 */
export const applicationPrescreeningForm: ResidenceDocument = {
  key: 'form_application_prescreening',
  name: 'Application & Pre-Screening Form',
  category: 'form',
  version: '2.0',
  summary:
  ...
  narrReferences: ['1.B.5.a — applicants informed before agreement'],
  iowaChecklist: ['Item 7 — eligibility pathway documented'],
  body: `# Grace House Application & Pre-Screening Form
