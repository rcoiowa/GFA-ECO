...
const checks = [
  ...
  ['light ink-faint on surface', T.light.inkFaint, T.light.surface, 4.5],
  ['light ink-faint on raised', T.light.inkFaint, T.light.raised, 4.5],
  ['light ink-faint on sunken', T.light.inkFaint, T.light.sunken, 4.5],
  ...
  ['dark ink-faint on surface', T.dark.inkFaint, T.dark.surface, 4.5],
  ['dark ink-faint on raised', T.dark.inkFaint, T.dark.raised, 4.5],
