...
const sql = readFileSync(
  'supabase/launch/prepared/0148_view_and_function_exposure_hardening.prepared.sql',
  'utf8',
);
const rollback = readFileSync(
  'supabase/launch/prepared/0148_view_and_function_exposure_hardening.rollback.sql',
  'utf8',
);
...
if (/grant [^;]*to [^;]*anon/i.test(sqlStatements)) {
  failures.push('prepared 0148 grants something to anon');
}
...
console.log('0148 prepared exposure-hardening invariants verified.');
