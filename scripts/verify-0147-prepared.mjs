...
const sql = readFileSync('supabase/launch/prepared/0147_shared_intake_workflow.prepared.sql', 'utf8');
const required = [
  ...
  ['linked-intake one-to-one index', /create unique index if not exists leads_linked_intake_id_idx/],
  ...
  ['reopen clears classification with audit', /'lead\.reopened'/],
