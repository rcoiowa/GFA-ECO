-- Applied live 2026-08-02 as `recoveryos_0014_fix_document_policy_recursion`
-- by a parallel session; captured back into the repo during the 2026-08-04
-- reconciliation (the live name collides with this repo's 0014, so the file
-- is numbered 0020 — see docs/migration/live-drift-reconciliation.md).
--
