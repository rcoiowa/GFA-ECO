        ...
        <div className="flex flex-col gap-5">
          ...
          <Card>
            ...
            <div className="mt-3 flex flex-wrap gap-4">
              <Link to="/support/grounding" className="font-medium text-experience-700 underline underline-offset-2">
                Grounding moment
              </Link>
              <Link to="/learn" className="font-medium text-experience-700 underline underline-offset-2">
                Explore Learn
              </Link>
            </div>
          </Card>
